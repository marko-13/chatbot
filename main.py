...
if __name__ == "__main__":
    if 'bert' in sys.argv:
        ...
        if 'train' in sys.argv:
            rnn_model = RNNModel(list_of_pairs, pair_y, train=True, elmo=True)
        else:
            rnn_model = RNNModel(list_of_pairs, pair_y, elmo=True)
        ...
        # and our RNN for distance measuring
        dict_orig = index_dataset()
